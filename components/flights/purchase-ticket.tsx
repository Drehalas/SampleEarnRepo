...
export const suggestions = ['Show flight status', 'Show boarding pass for flight'];
            ...
            <div className="grid gap-4 p-4 sm:p-6 border border-zinc-200 rounded-2xl bg-white">
                ...
                {currentStatus === 'requires_confirmation' ? (
                    <div className="flex flex-col gap-4">
                        <p>
                            Thanks for choosing your flight and hotel reservations! Confirm your purchase to
                    ...
                    <>
                        <div>Enter the code sent to your phone (***) *** 6137 to complete your purchase.</div>
                    ...
                    <div className="flex items-center justify-center gap-3">Your Session has expired!</div>
                ) : null}
            </div>
